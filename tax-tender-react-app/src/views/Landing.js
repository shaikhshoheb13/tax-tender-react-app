    ...
    <>
      ...
      <main>
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          ...
          <div className="container relative mx-auto -mt-48">
              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  ...
                  <p className="mt-4 text-lg text-gray-300">
                    We help people and organizations improve their financial security 
                    and make informed decisions about tax and tender related issues.<br />
                    We also help you to make Government Documentation.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <Link target="_" to="/tender" className="">
